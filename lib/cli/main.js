...
var gobytecorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = gobytecorenode.version;
  var create = gobytecorenode.scaffold.create;
  var add = gobytecorenode.scaffold.add;
  var start = gobytecorenode.scaffold.start;
  var remove = gobytecorenode.scaffold.remove;
  var callMethod = gobytecorenode.scaffold.callMethod;
  var findConfig = gobytecorenode.scaffold.findConfig;
  var defaultConfig = gobytecorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the GoByte database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make gobytecore-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `gobytecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ gobytecore-node add wallet-service');
      console.log('    $ gobytecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ gobytecore-node remove wallet-service');
      console.log('    $ gobytecore-node remove insight-api');
      console.log();
    });
